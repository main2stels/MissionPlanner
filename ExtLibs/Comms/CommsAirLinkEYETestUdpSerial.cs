...
{
    public class AirLinkEYETestUdpSerial : UdpSerial
    {
        private static int _startPort = 14570;
        private string _airLinkLogin = "";
        private Action<byte[], byte[]> _airLinkLoginSendFunc;
        private Action _eyeConnectionStart;
        private Action _eyeConnectionClose;
        //private string _hostName = "air-link.space";
        private string _hostName = "airlink.biruch.ru";
        ...
        public AirLinkEYETestUdpSerial(Action<byte[], byte[]> airLinkLoginSendFunc, Action eyeConnectionStart, Action eyeConnectionClose)
        {
        ...
        public AirLinkEYETestUdpSerial(UdpClient client, Action<byte[], byte[]> airLinkLoginSendFunc) : base(client)
        {
            _airLinkLoginSendFunc = airLinkLoginSendFunc;
        }
        ...
        public override void Open()
        {
            ...
            while (true)
            {
                _airLinkLoginSendFunc.Invoke(login, pass);
                Thread.Sleep(1500);
