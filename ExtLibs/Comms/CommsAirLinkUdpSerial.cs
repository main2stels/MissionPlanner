...
{
    public class AirLinkUdpSerial : UdpSerial
    {
        ...
        {
            get => _airLinkLogin + " AIR-LINK" + ":" + Port;
            set { }
        }

        public AirLinkUdpSerial(Func<byte[], byte[], byte[]> airLinkLoginSendFunc)
        {
            _airLinkLoginSendFunc = airLinkLoginSendFunc;
        }

        public AirLinkUdpSerial(UdpClient client, Func<byte[], byte[], byte[]> airLinkLoginSendFunc) : base(client)
        {
            _airLinkLoginSendFunc = airLinkLoginSendFunc;
        }
